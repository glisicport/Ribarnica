...
<div class="bg-pozadina flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-lg">
        ...
        <div class="bg-white shadow-2xl rounded-xl p-8 sm:p-10 border border-gray-200/50">
            ...
            <?php if($errors->has('email') && $errors->first('email') === 'Ovi podaci se ne podudaraju sa našim zapisima.'): ?>
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
                    <span class="block sm:inline"><?php echo e($errors->first('email')); ?></span>
                </div>
            <?php endif; ?>
            <!-- ---------------------------------------------------- -->
            ...
            <form action="<?php echo e(route('prijava.login')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?> 
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <?php if($message !== 'Ovi podaci se ne podudaraju sa našim zapisima.'): ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-gray-500 text-base mt-6">
                Nemate nalog? 
                <a class="text-glavna hover:text-glavna-hover font-semibold transition duration-150" href="<?php echo e(route('registracija')); ?>">
                    Registrujte se!
                </a>
            </p>
...
</html><?php /**PATH /var/www/html/resources/views/prijava/index.blade.php ENDPATH**/ ?>