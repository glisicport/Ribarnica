   <!-- CATEGORY MODAL -->
    <div id="categoryModal" class="modal-hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form id="categoryForm" method="POST" action="<?php echo e(route('admin.categories.store')); ?>" class="px-8 py-6 space-y-6">
                <?php echo csrf_field(); ?>
    ...
    </div><?php /**PATH /var/www/html/resources/views/admin/products/categoryModal.blade.php ENDPATH**/ ?>