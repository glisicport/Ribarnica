...
<h1 class="main-title"><?php echo e($about->title); ?></h1>

<div class="about-wrapper">
    <div class="about-text">
        <h3><?php echo e($about->short_description); ?></h3>
        <p><?php echo e($about->long_description); ?></p>
    </div>
...
<div class="employees-grid">
    <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="employee-card">
            <img class="employee-photo" src="<?php echo e(asset('storage/' . $emp->photo)); ?>" alt="Foto zaposlenog">

            <div class="employee-name"><?php echo e($emp->name); ?> <?php echo e($emp->last_name); ?></div>
            <div class="employee-position"><?php echo e($emp->position); ?></div>
            <p class="employee-bio"><?php echo e($emp->bio); ?></p>
        </div>
...
<?php /**PATH /var/www/html/resources/views/about_us/index.blade.php ENDPATH**/ ?>