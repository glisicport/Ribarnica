                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-3 flex items-center justify-between gap-4">
                                    <form action="<?php echo e(route('cart.update', $item->id)); ?>" method="POST" class="flex items-center gap-2">
                                        ...
                                        <input type="number" name="quantity" value="<?php echo e($item->quantity); ?>" min="0.1" step="0.1" class="w-16 text-center px-2 py-1 rounded-md border" />
                        ...
                        <div class="border-t pt-3 mt-3">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="text-lg font-bold">
                                    <?php echo e($cart ? number_format($cart->items->sum(fn($i) => $i->quantity * $i->price), 2) : '0.00'); ?> RSD
                                </div>
                            </div>
