                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative hidden md:flex group">
                        <button
                            ...
                            <span class="text-white font-medium">Korisnik: <?php echo e(Auth::user()->name); ?></span>
                        ...
                        <div
                            ...
                            <a href="<?php echo e(Auth::user()->role === 'admin' ? '/kontrolni-panel' : '/korisnicki-nalog'); ?>"
                                class="block px-4 py-2 text-white hover:bg-indigo-600/50 hover:text-white rounded-md transition duration-150">
                                <i class="fas fa-cog mr-2"></i> 
                                <?php echo e(Auth::user()->role === 'admin' ? 'Kontrolni panel' : 'Korisnički panel'); ?>

                            </a>
                            

                            <form method="POST" action="<?php echo e(route('odjava')); ?>" class="pt-1 border-t border-gray-700 mt-1">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
        ...
        <nav id="mobileMenu" class="hidden lg:hidden mt-4 pb-4 space-y-3 border-t border-blue-500 pt-4">
            ...
            <div class="flex flex-col space-y-3 pt-3 border-t border-blue-500">
                ...
                <a href="<?php echo e(Auth::user()->role === 'admin' ? '/kontrolni-panel' : '/korisnicki-nalog'); ?>" 
                    ...
                    <span><?php echo e(Auth::user()->role === 'admin' ? 'Kontrolni panel' : 'Korisnički panel'); ?> (<?php echo e(Auth::user()->name); ?>)</span>
                </a>
                

                <form method="POST" action="<?php echo e(route('odjava')); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
...
</header><?php /**PATH /var/www/html/resources/views/common/topbar.blade.php ENDPATH**/ ?>