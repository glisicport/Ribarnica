 <aside class="sidebar sidebar-transition w-72 bg-slate-900 text-white flex flex-col fixed lg:relative z-50 shadow-2xl h-full">
  ...
  <!-- Link: Employees -->
                <a href="<?php echo e(route('kontrolni-panel', ['page_type' => 'poruke'])); ?>" class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 hover:bg-brand-600 hover:shadow-lg hover:shadow-brand-500/20 text-slate-300 hover:text-white <?php echo e(request('page_type') == 'poruke' ? 'bg-brand-600 text-white' : ''); ?>">
                    <svg class="mr-3 h-5 w-5 text-slate-400 group-hover:text-white transition-colors <?php echo e(request('page_type') == 'poruke' ? 'text-white' : ''); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 8.048M12 4.354L9.172 7.226M15.828 7.226L12 4.354m0 0L4.929 11.86M12 4.354l7.071 7.506" />
                    </svg>
                    Poruke
                </a>
...
<!-- FAQ Menadžer -->
<a href="<?php echo e(route('kontrolni-panel', ['page_type' => 'faq'])); ?>"
   class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200
          ...
          <?php echo e(request('page_type') == 'faq' ? 'bg-brand-600 text-white' : ''); ?>">
    <svg class="mr-3 h-5 w-5 text-slate-400 group-hover:text-white transition-colors
                <?php echo e(request('page_type') == 'faq' ? 'text-white' : ''); ?>"
