            ...
            <div class="flex flex-col lg:flex-row gap-10 items-start lg:items-center">
                ...
                <div class="flex-1 space-y-4">
                    <div class="inline-flex items-center gap-3 fish-badge bg-sky-50 border border-sky-100 px-4 py-1 rounded-full">
                        ...
                        <span class="text-xs tracking-[0.2em] uppercase text-sky-700">
                            <?php echo e($contactInfo->store_name ?? 'TFZR Ribarnica'); ?>

                        </span>
                    </div>

                    <h1 class="text-3xl md:text-4xl font-bold leading-tight text-slate-900">
                        <?php echo e($contactInfo->title ?? 'Ribarnica TFZR'); ?>

                    </h1>

                    <p class="text-slate-600 text-base md:text-lg max-w-xl">
                        <?php echo e($contactInfo->subtitle ?? 'Dobrodošli u studentsku ribarnicu TFZR – mesto gde se tradicija, znanje i sveža riba sreću na jednom mestu.'); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                        ...
                        <div class="contact-card bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                            <p class="text-xs uppercase tracking-[0.16em] text-slate-400 mb-1">
                                <?php echo e($contactInfo->email_label ?? 'Email'); ?>

                            </p>
                            <p class="font-semibold text-slate-900 text-lg flex items-center gap-2">
                                <i class="fas fa-envelope-open-text text-sky-500"></i>
                                <?php echo e($contactInfo->email_value ?? 'tfzrrb@gmail.com'); ?>
                        ...
                        <div class="contact-card bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                            <p class="text-xs uppercase tracking-[0.16em] text-slate-400 mb-1">
                                <?php echo e($contactInfo->hours_label ?? 'Radno vreme'); ?>

                            </p>
                            <p class="font-semibold text-slate-900 text-sm leading-relaxed">
                                <?php echo e($contactInfo->hours_value ?? 'Pon–Pet: 07–20h · Subota: 07–18h · Nedelja: 08–15h'); ?>
                ...
                <div class="w-full lg:w-72 contact-card bg-sky-50 border border-sky-100 rounded-2xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-2 text-sm text-slate-700">
                        <?php $__empty_1 = true; $__currentLoopData = $quickFacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="flex gap-3">
                                <span class="text-sky-500">•</span>
                                <span><?php echo e($fact->text); ?></span>
                            </li>
                ...
                <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="4" required
                                  class="w-full px-4 py-2.5 rounded-lg bg-white border border-slate-300 text-slate-900 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 resize-y"><?php echo e(old('message')); ?></textarea>
                    </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <article class="faq-item border border-slate-200 rounded-xl overflow-hidden" data-faq>
                                <button type="button" class="faq-question w-full flex items-center justify-between px-4 py-3 bg-slate-50 hover:bg-slate-100">
                                    <span class="text-sm md:text-base font-medium text-slate-900 text-left pr-4"><?php echo e($faq->question); ?></span>
                                ...
                                <div class="faq-answer px-4 pb-3 text-sm text-slate-700" style="max-height:0; overflow:hidden; transition:max-height .25s ease;">
                                    <p class="py-2 border-t border-slate-200 mt-1"><?php echo e($faq->answer); ?></p>
                                </div>
                            </article>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <div class="border border-slate-200 rounded-xl px-4 py-3 mb-3 bg-slate-50">
                            <div class="flex items-center justify-between mb-1.5">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm font-semibold text-slate-900"><?php echo e($q->username); ?></span>
                                </div>
                                <span class="text-[11px] text-slate-500"><?php echo e($q->created_at->format('d.m.Y. H:i')); ?></span>
                            </div>
                            <p class="text-sm text-slate-800 mb-2 whitespace-pre-line"><?php echo e($q->message); ?></p>
                            ...
                            <?php if($q->comment): ?>
                                <div class="mt-2 border-t border-slate-200 pt-2 flex items-start gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-800 mt-1 whitespace-pre-line"><?php echo e($q->comment); ?></p>
                                    </div>
                                </div>
                            <?php else: ?>
...
<?php /**PATH /var/www/html/resources/views/contact/index.blade.php ENDPATH**/ ?>