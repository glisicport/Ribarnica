...
<?php endif; ?>
        ...
        <div class="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <aside class="w-full lg:w-1/4 lg:sticky lg:top-28 transition-all">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <?php if(request()->hasAny(['category', 'search', 'sort', 'min_price', 'max_price'])): ?>
                        <a href="<?php echo e(route('proizvodi')); ?>"
                            class="text-xs font-semibold text-red-500 hover:text-red-700 uppercase tracking-wide">
                            Obriši sve
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <a href="<?php echo e(route('proizvodi', request()->except(['category', 'page']))); ?>"
                                class="flex items-center justify-between group py-1.5 px-2 rounded-lg transition-colors <?php echo e(!request('category') ? 'active-filter font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                                <span>Svi proizvodi</span>
                                <?php if(!request('category')): ?> <i class="fas fa-check text-xs"></i> <?php endif; ?>
                            </a>

                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('proizvodi', array_merge(request()->except(['page']), ['category' => $category->slug]))); ?>"
                                    class="flex items-center justify-between group py-1.5 px-2 rounded-lg transition-colors <?php echo e(request('category') == $category->slug ? 'active-filter font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">

                                    <span class="capitalize"><?php echo e($category->name); ?></span>
                    ...
                    <div>
                        ...
                        <form action="<?php echo e(route('proizvodi')); ?>" method="GET">
                            <?php if(request('category')): ?> <input type="hidden" name="category"
                            value="<?php echo e(request('category')); ?>"> <?php endif; ?>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div class="relative w-full">
                                    <input type="number" name="max_price" value="<?php echo e(request('max_price')); ?>"
                                        placeholder="Do" min="0"
                                        class="w-full pl-3 pr-2 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:bg-white outline-none">
                                </div>
                            </div>
                            <button type="submit"
                                class="w-full mt-3 bg-blue-600 text-white text-sm py-2 rounded-lg hover:bg-blue-700 transition-colors shadow-md">
                                Primeni filter
                            </button>
                        </form>
                    </div>
            ...
            <main class="w-full lg:w-3/4">
                ...
                <div
                    ...
                    <div class="container mx-auto px-4 py-4">
                        <form action="<?php echo e(route('proizvodi')); ?>" method="GET" class="max-w-3xl mx-auto relative group">
                            <?php if(request('category')): ?> <input type="hidden" name="category"
                            value="<?php echo e(request('category')); ?>"> <?php endif; ?>
                            <?php if(request('sort')): ?> <input type="hidden" name="sort" value="<?php echo e(request('sort')); ?>"> <?php endif; ?>
                            <?php if(request('min_price')): ?> <input type="hidden" name="min_price"
                            value="<?php echo e(request('min_price')); ?>"> <?php endif; ?>
                            <?php if(request('max_price')): ?> <input type="hidden" name="max_price"
                            value="<?php echo e(request('max_price')); ?>"> <?php endif; ?>
                            ...
                            <div class="relative">
                                ...
                                <i
                                    class="fas fa-search absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg group-focus-within:text-blue-600 transition-colors"></i>

                                <?php if(request('search')): ?>
                                    <a href="<?php echo e(route('proizvodi', request()->except('search'))); ?>"
                    ...
                    <form action="<?php echo e(route('proizvodi')); ?>" method="GET" class="flex items-center gap-3">
                        <?php if(request('category')): ?> <input type="hidden" name="category" value="<?php echo e(request('category')); ?>">
                        <?php endif; ?>
                        <?php if(request('search')): ?> <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
                        <?php endif; ?>
                        <?php if(request('min_price')): ?> <input type="hidden" name="min_price"
                        ...
                        <div class="relative">
                            <select name="sort" onchange="this.form.submit()"
                                ...
                                <option value="newest" <?php echo e(request('sort') == 'newest' ? 'selected' : ''); ?>>Najnovije
                                </option>
                                <option value="price_asc" <?php echo e(request('sort') == 'price_asc' ? 'selected' : ''); ?>>Cena:
                                    Rastuća</option>
                                <option value="price_desc" <?php echo e(request('sort') == 'price_desc' ? 'selected' : ''); ?>>Cena:
                                    Opadajuća</option>
                                <option value="name_asc" <?php echo e(request('sort') == 'name_asc' ? 'selected' : ''); ?>>Naziv: A-Z
                                </option>
                            </select>
                            <i
                                class="fas fa-chevron-down absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-gray-400 pointer-events-none"></i>
                        </div>
                    </form>
                </div>
                ...
                <?php if($products->count() > 0): ?>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                class="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl hover:border-blue-300 transition-all duration-300 flex flex-col relative">
                                ...
                                <div class="relative aspect-[4/3] overflow-hidden bg-gray-50">
                                    ...
                                    <span
                                        class="absolute top-3 left-3 px-2 py-1 bg-white/90 backdrop-blur-sm text-[10px] font-bold uppercase tracking-wider text-gray-800 rounded shadow-sm">
                                        <?php echo e($product->category ? $product->category->name : 'Riba'); ?>
                                ...
                                <div class="p-5 flex flex-col flex-grow">
                                    ...
                                    <p class="text-sm text-gray-500 line-clamp-2 mb-4 flex-grow">
                                        <?php echo e($product->description ?? 'Sveže i kvalitetno.'); ?>
                                    ...
                                    <div class="flex items-center justify-between pt-4 border-t border-gray-50 mt-auto">
                                        <div>
                                            <span
                                                class="text-xl font-bold text-blue-600"><?php echo e(number_format($product->price, 2, ',', '.')); ?></span>
    ...
    <button
        @click="open = true; productId = <?php echo e($product->id); ?>;"
            ...
            <form :action="`/cart/add/${productId}`" method="POST">
                ...
                <?php else: ?>
                    <div class="text-center py-16 bg-white rounded-2xl border border-gray-100 border-dashed">
                        ...
                        <a href="<?php echo e(route('proizvodi')); ?>"
                            class="inline-flex items-center px-6 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors">
    ...
    <footer class="bg-white border-t border-gray-200 py-12 mt-12">
        <div class="container mx-auto px-4 text-center">
            <p class="text-gray-500 text-sm">&copy; <?php echo e(date('Y')); ?> Ribarnica Tfzr. Sva prava zadržana.</p>
        </div>
    </footer>
...
</html><?php /**PATH /var/www/html/resources/views/products.blade.php ENDPATH**/ ?>