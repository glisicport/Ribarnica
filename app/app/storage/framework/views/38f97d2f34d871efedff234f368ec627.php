...
<section class="mt-16 px-4 max-w-7xl mx-auto pb-20">
    ...
    <div class="relative bg-gradient-to-br from-blue-50 via-cyan-50 to-blue-100 rounded-3xl shadow-2xl overflow-hidden p-6 md:p-16 border border-blue-200/50" id="slider">
        ...
        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="slide hidden relative z-10" data-category="<?php echo e($category); ?>">
                <div class="flex flex-col items-center">
                    ...
                    <div class="relative w-full max-w-5xl mb-8 group">
                        ...
                        <div class="relative rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/50">
                            <img src="<?php echo e(asset($image)); ?>" alt="<?php echo e($title); ?>" class="w-full h-auto object-cover transition-transform duration-700 group-hover:scale-110">
...
function showMeni(){
    ...
    if(!document.getElementById("meniSlide")){
        ...
        div.className = "slide";
        div.innerHTML = `
            <img src="<?php echo e(asset('storage/images/ambijent/meni.png')); ?>" style="width:100%; height:auto; object-fit:contain; border-radius:15px;">
        `;
...
<?php /**PATH /var/www/html/resources/views/gallery/index.blade.php ENDPATH**/ ?>