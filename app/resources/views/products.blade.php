                    ...
                    <div class="container mx-auto px-4 py-4">
                        <form action="{{ route('proizvodi') }}" method="GET" class="max-w-3xl mx-auto relative group">
                            ...
                            <div class="relative">
                                ...
                                @if(request('search'))
                                    <a href="{{ route('proizvodi', request()->except('search')) }}"
                    ...
                    <form action="{{ route('proizvodi') }}" method="GET" class="flex items-center gap-3">
                        ...
                        <div class="relative">
                            <select name="sort" onchange="this.form.submit()"
                                ...
                                <option value="newest" {{ request('sort') == 'newest' ? 'selected' : '' }}>Najnovije
                                </option>
                                <option value="price_asc" {{ request('sort') == 'price_asc' ? 'selected' : '' }}>Cena:
                                    Rastuća</option>
                                <option value="price_desc" {{ request('sort') == 'price_desc' ? 'selected' : '' }}>Cena:
                                    Opadajuća</option>
                                <option value="name_asc" {{ request('sort') == 'name_asc' ? 'selected' : '' }}>Naziv: A-Z
                                </option>
                            </select>
                            <i
