                   ...
                   <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                       ...
                       <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-200">
                           ...
                           <div class="p-6">
                               ...
                               <a href="{{ route('profil.edit') }}" class="inline-block w-full text-center py-2 px-4 text-white font-bold rounded-lg bg-gradient-to-r from-glavna to-indigo-500 hover:from-glavna-hover hover:to-indigo-600 transition duration-300">
                       ...
                       <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-200">
                           ...
                           <div class="p-6">
                               ...
                               <a href="{{ route('profil.change-password') }}" class="inline-block w-full text-center py-2 px-4 text-white font-bold rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 transition duration-300">
                       ...
                       <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-200">
                           ...
                           <div class="p-6">
                               ...
                               <a href="{{ route('cart.view') }}" class="inline-block w-full text-center py-2 px-4 text-white font-bold rounded-lg bg-gradient-to-r from-orange-400 to-red-500 hover:from-orange-500 hover:to-red-600 transition duration-300">
                       ...
                       <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-200">
                           ...
                           <div class="p-6">
                               ...
                               <a href="{{ route('order.history') }}" class="inline-block w-full text-center py-2 px-4 text-white font-bold rounded-lg bg-gradient-to-r from-teal-400 to-cyan-500 hover:from-teal-500 hover:to-cyan-600 transition duration-300">
                   ...
                   <div class="mt-8 bg-white rounded-lg shadow-md p-8 border border-gray-200">
                       ...
                       <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                           <div>
                               ...
                               <p class="text-gray-900 font-medium text-lg mt-1">{{ Auth::user()->name }}</p>
                           </div>
                           <div>
                               <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">E-mail Adresa</p>
                               <p class="text-gray-900 font-medium text-lg mt-1">{{ Auth::user()->email }}</p>
                           </div>
                           <div>
                               <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">Telefonski Broj</p>
                               <p class="text-gray-900 font-medium text-lg mt-1">{{ Auth::user()->phone ?? 'Nije navedeno' }}</p>
                           </div>
                           <div>
                               <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">Grad</p>
                               <p class="text-gray-900 font-medium text-lg mt-1">{{ Auth::user()->city ?? 'Nije navedeno' }}</p>
                           </div>
                           <div>
                               <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">Adresa</p>
                               <p class="text-gray-900 font-medium text-lg mt-1">{{ Auth::user()->address ?? 'Nije navedeno' }}</p>
                           </div>
                           <div>
                               <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">Poštanski Broj</p>
                               <p class="text-gray-900 font-medium text-lg mt-1">{{ Auth::user()->postal_code ?? 'Nije navedeno' }}</p>
                           </div>
                           <div class="md:col-span-2">
                               <p class="text-gray-500 text-sm font-semibold uppercase tracking-wide">Država</p>
                               <p class="text-gray-900 font-medium text-lg mt-1">{{ Auth::user()->country ?? 'Nije navedeno' }}</p>
                           </div>
                       </div>

                       <div class="mt-6">
                           <a href="{{ route('profil.edit') }}" class="py-2 px-6 text-white font-bold rounded-lg bg-gradient-to-r from-glavna to-indigo-500 hover:from-glavna-hover hover:to-indigo-600 transition duration-300">
